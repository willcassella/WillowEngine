...
CXX=clang++
CFLAGS=-std=c++14 -Ofast -Wall -Wextra -Wpedantic -I ../../Modules/Core/include -I ../../Modules/Resource/include -I ../../Modules/Engine/include -I ../../Services/GLRender/include -I ../../Games/ExampleGame/include `pkg-config glfw3 --cflags`
