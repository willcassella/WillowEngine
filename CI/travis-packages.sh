...
cd bullet3-2.83.7 && cmake ./ -DBUILD_SHARED_LIBS=ON -DBUILD_BULLET3=OFF -DBUILD_BULLET2_DEMOS=OFF -DBUILD_CPU_DEMOS=OFF -DBUILD_UNIT_TESTS=OFF && make && sudo make install && cd ..
