...
public:
	...
	void EnumerateProperties(const EnumeratorView<const PropertyInfo&>& enumerator) const final override;
	...
	void EnumerateData(const EnumeratorView<const DataInfo&>& enumerator) const final override;
