...
public:
	...
	void EnumerateProperties(EnumeratorView<const PropertyInfo&> enumerator) const final override;
	...
	void EnumerateData(EnumeratorView<const DataInfo&> enumerator) const final override;
