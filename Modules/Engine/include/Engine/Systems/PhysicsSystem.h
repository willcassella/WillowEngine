...
namespace Willow
{
	...
	public:
		...
		virtual void CreateEntity(EntityHandle entity, EntityHandle parent, Transform& transform, Entity::PhysicsMode mode, Entity::PhysicsState state) = 0;
		...
		virtual void CreateCollider(GHandle<SphereColliderComponent> component, EntityHandle entity, const Transform& transform, SphereColliderComponent::Shape shape) = 0;

		/** Creates a CapsuleCollider for the given component. */
		virtual void CreateCollider(GHandle<CapsuleColliderComponent> component, EntityHandle entity, const Transform& transform, CapsuleColliderComponent::Shape shape) = 0;

		/** Creates a StaticMeshCollider for the given component. */
		virtual void CreateCollider(GHandle<StaticMeshColliderComponent> component, EntityHandle entity, const Transform& transform, StaticMeshColliderComponent::Shape shape) = 0;
